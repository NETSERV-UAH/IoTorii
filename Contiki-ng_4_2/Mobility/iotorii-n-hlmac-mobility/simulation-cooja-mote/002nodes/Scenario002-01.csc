...
<simconf>
  ...
  <simulation>
	...
	<mote>
		...
		<x>4.507282841544642</x>
		<y>11.96281140639386</y>
		<z>0.0</z>
		</interface_config>
		<interface_config>
	...
	<mote>
		<interface_config>
		org.contikios.cooja.interfaces.Position
		<x>13.65505462064831</x>
		<y>32.91922743003111</y>
		<z>0.0</z>
		</interface_config>
		<interface_config>
		org.contikios.cooja.contikimote.interfaces.ContikiMoteID
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>15.009506119303564 0.0 0.0 15.009506119303564 57.69614236017926 -163.8286182810704</viewport>
    </plugin_config>
    <width>400</width>
    <z>4</z>
    <height>400</height>
