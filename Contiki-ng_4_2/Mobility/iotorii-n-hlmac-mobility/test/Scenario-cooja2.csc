...
<simconf>
  ...
  <simulation>
    ...
    <motetype>
      org.contikios.cooja.contikimote.ContikiMoteType
      <identifier>mtype867</identifier>
    ...
    <mote>
      <interface_config>
        ...
        <x>2.823649938724862</x>
        <y>17.027478488480895</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>17.119818051315708</x>
        <y>24.69950559770465</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
      ...
      <motetype_identifier>mtype867</motetype_identifier>
    </mote>
  </simulation>
  <plugin>
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>24.672854288599236 0.0 0.0 24.672854288599236 -52.03113986380703 -341.7618991305776</viewport>
    </plugin_config>
    <width>400</width>
    <z>1</z>
    <height>400</height>
...
function checkConvergence(idMax, numHLMAC){
    ...
    if (converged == 1){
        log.log("converged\n");
        //log.testOK();  //It doesn't work for the Cooja mote
        log.log("testOK\n");
        exit(0);
    }else{
