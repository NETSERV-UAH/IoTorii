...
<simconf>
  ...
  <simulation>
	...
	<mote>
		...
		<x>3.2640219984449286</x>
		<y>24.315693130879822</y>
		<z>0.0</z>
		</interface_config>
		<interface_config>
	...
	<mote>
		<interface_config>
		org.contikios.cooja.interfaces.Position
		<x>1.0306171279455851</x>
		<y>25.132347266904475</y>
		<z>0.0</z>
		</interface_config>
		<interface_config>
		org.contikios.cooja.contikimote.interfaces.ContikiMoteID
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>157.93252597698964 0.0 0.0 157.93252597698964 -145.13160269523297 -3731.7269623171505</viewport>
    </plugin_config>
    <width>400</width>
    <z>0</z>
    <height>400</height>
