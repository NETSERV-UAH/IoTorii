...
void IoToriiOperation::sendAndScheduleHello()
{
    ...
    CSMAFrameIoTorii *macPkt = new CSMAFrameIoTorii("Hello!");
    AddressStruct dst;
...
void IoToriiOperation::startCore(int core)
{
    ...
    CSMAFrameIoTorii *SetHLMACFrame = new CSMAFrameIoTorii ("SetHLMAC");
    AddressStruct src;
    src.eGA3 = eGA3;
...
void IoToriiOperation::sendToNeighbors(CSMAFrameIoTorii *frame)
{
    ...
    for (int i = 1; i <= numNeighbors && i <= maxNeighbors; i++) {  //Second condition is related on the width of HLMACAddress, 3 bits allowed 3 neighbor, 00 is reserved for NOTSPECIFIED address
        ...
        CSMAFrameIoTorii *dupFrame = frame->dup();
...
void IoToriiOperation::receiveSetHLMACMessage(CSMAFrameIoTorii *frame)
{
...
void IoToriiOperation::handleLowerPacket(cPacket *msg)
{
    ...
    {
        CSMAFrameIoTorii *frame = check_and_cast<CSMAFrameIoTorii *>(msg);
        numHelloRcvd++;
