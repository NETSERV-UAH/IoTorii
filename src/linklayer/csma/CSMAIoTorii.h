...
#ifndef IOTORII_SRC_LINKLAYER_CSMA_CSMAIOTORII_H
#define IOTORII_SRC_LINKLAYER_CSMA_CSMAIOTORII_H
...
//  cObject* setDownControlInfo(cMessage * const pMsg, Signal * const pSignal);
  ...
  private:
     ...
     */
    CSMAIoTorii(const CSMAIoTorii&);
    /** @brief Assignment operator is not allowed.
     */
    CSMAIoTorii& operator=(const CSMAIoTorii&);
};

} // namespace iotorii

#endif // ifndef IOTORII_SRC_LINKLAYER_CSMA_CSMAIOTORII_H
