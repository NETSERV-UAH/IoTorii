...
#ifndef IOTORII_SRC_NETWORKLAYER_ICMPV6_IPV6NEIGHBOURDISCOVERYIOTORII_H
#define IOTORII_SRC_NETWORKLAYER_ICMPV6_IPV6NEIGHBOURDISCOVERYIOTORII_H
...
//#include "inet/networklayer/icmpv6/IPv6NeighbourCache.h" //EXTRA
...
class IPv6NeighbourDiscoveryIoTorii : public cSimpleModule, public ILifecycle
{
  public:
    ...
    typedef IPv6NeighbourCacheIoTorii::DefaultRouterList DefaultRouterList;    // for convenience

  public:
    IPv6NeighbourDiscoveryIoTorii();
    virtual ~IPv6NeighbourDiscoveryIoTorii();
  ...
  protected:
    ...
    IPv6NeighbourCacheIoTorii neighbourCache;
  ...
  protected:
    ...
    virtual IPv6NeighbourDiscoveryIoTorii::AdvIfEntry *fetchAdvIfEntry(InterfaceEntry *ie);
    virtual IPv6NeighbourDiscoveryIoTorii::RDEntry *fetchRDEntry(InterfaceEntry *ie);
  ...
  protected:    // update 12.9.07 - CB
    ...
    virtual void processNAForIncompleteNCEState(IPv6NeighbourAdvertisement *na,
            IPv6NeighbourCacheIoTorii::Neighbour *nce);
...
#endif    //IOTORII_SRC_NETWORKLAYER_ICMPV6_IPV6NEIGHBOURDISCOVERYIOTORII_H
