...
#ifndef IOTORII_SRC_NETWORKLAYER_IPV6_IPV6IOTORII_H
#define IOTORII_SRC_NETWORKLAYER_IPV6_IPV6IOTORII_H
 ...
 * IPv6 implementation.
 */
class IPv6IoTorii : public QueueBase, public ILifecycle, public INetfilter, public INetworkProtocol
{
  public:
    /**
  ...
  protected:
    ...
    IPv6NeighbourDiscoveryIoTorii *nd = nullptr;  //EXTRA
    ICMPv6 *icmp = nullptr;
...
#endif // ifndef IOTORII_SRC_NETWORKLAYER_IPV6_IPV6IOTORII_H
